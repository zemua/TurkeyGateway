...
class UserManagementTest {
	...
	@MockBean
	@Qualifier("usermgm")
	private EndpointMapper userMgmEndpoint;
	...
	@Test
	void testCreateForwarding() throws InterruptedException, URISyntaxException {
		mockWebServer.enqueue(new MockResponse()
				.setBody(mockCreateResponseBody())
				.setResponseCode(201));

		when(userMgmEndpoint.getEndpointUri()).thenReturn(new URI("http://localhost:" + mockWebServer.getPort()));
	...
	private String mockCreateResponseBody() {
		return "{\n"
